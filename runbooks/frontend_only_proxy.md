...
## Grab the Certs
Grab the [frontend_only_certs](https://drive.google.com/drive/folders/102UD3jYLk1560_KN_skJoZDWREVcKWls) directory from Google Drive and copy it to `transposit/proxy` (in your copy of the source repo).
